const currencyCode=[
  ...
  { code: "IMP", name: "Isle of Man Pound", country: "Isle of Man" },
  ...
  { code: "UZS", name: "Uzbekistani Soʻm", country: "Uzbekistan" },
  ...
  { code: "XCD", name: "East Caribbean Dollar", country: "East Caribbean Countries" },
  { code: "XDR", name: "IMF Special Drawing Rights", country: "International Monetary Fund" },
  { code: "XOF", name: "West African CFA Franc", country: "West African Countries" },
  { code: "XPF", name: "CFP Franc", country: "Pacific Territories" },
